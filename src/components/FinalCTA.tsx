...
const FinalCTA = () => {
  ...
  return <section id="order" className="relative bg-fitBlack py-20 md:py-32 overflow-hidden">
      <div ref={parallaxRef} className="container relative z-10 parallax-container">
        <div className="max-w-4xl mx-auto text-center">
          <div className="parallax-layer">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>YOUR NEW LIFESTYLE AWAITS</h2>
          </div>
          
          <div className="parallax-layer">
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-12 animate-fade-in" style={{
            animationDelay: '0.4s'
          }}>
          ...
          <div className="parallax-layer">
            <button className="bg-fitYellow text-fitBlack font-bold px-8 py-4 rounded-md text-lg shadow-xl hover:shadow-fitYellow/30 transition-all duration-300 hover:-translate-y-1 animate-fade-in" style={{
            animationDelay: '0.6s'
          }}>
              ORDER NOW – Limited Stock Available!
            </button>
            <p className="text-white/60 mt-4 text-sm animate-fade-in" style={{
            animationDelay: '0.8s'
          }}>
